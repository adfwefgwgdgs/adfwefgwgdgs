...
AMAZON_URL = 'https://www.amazon.com/dp/B09DFHJTF5?smid=ATVPDKIKX0DER&tag=data20-20'
AMAZON_TEST_URL = 'https://www.amazon.com/dp/B09DFHJTF5?smid=ATVPDKIKX0DER&tag=data20-20'
WAIT_TIME = 5
PRICE_LIMIT = 700.00
...
class JahkRShop:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.microsoft edge()
